...
# sletter alle disse funktioner, da vores to energy resources ikke kører på brændstof
                                    #def fuelCost(db):
...
def mc(db):    
	return db['OtherMC'] # Vi arbejder kun med VE-anlæg, hvorfor MC ikke afhænger af brændstof
